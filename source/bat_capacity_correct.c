 ...
 *
 * 形状参考: 通用 4.4V/3.85V LiPo OCV-SOC 标准放电曲线
 * (TI BQ27Z561 / Qualcomm PM8941 BMS / Linux 内核 pc-temp-ocv-lut 综合)
 *
 * 端点重映射 (基于 Redmi Note 9 Pro 实测):
 *   3700mV 以下几乎无可用容量, 端电压快速下跌, PMIC 随时触发关机。
 *   4400mV(100%)→100%, 3700mV(~9.5%)→1% 线性拉伸:
 *     new = 1 + (old - 9.5) * 99 / 90.5
 *   端点: 4.400V (100%), 3.700V (1%)
 *
 * 100 个采样点, 每 1% SOC 一个锚点, 锚点间线性插值。
 */
static const int voltage_map[][2] = {
    /* mV,  SOC% */
    {4400, 100},
    {4373,  99}, {4365,  98}, {4358,  97}, {4351,  96}, {4343,  95},
    {4336,  94}, {4329,  93}, {4321,  92}, {4314,  91},
    {4307,  90}, {4300,  89}, {4294,  88}, {4289,  87}, {4283,  86},
    {4278,  85}, {4272,  84}, {4267,  83}, {4261,  82}, {4256,  81},
    {4250,  80}, {4245,  79}, {4239,  78}, {4234,  77}, {4228,  76},
    {4223,  75}, {4217,  74}, {4212,  73}, {4206,  72}, {4201,  71},
    {4195,  70}, {4190,  69}, {4184,  68}, {4179,  67}, {4174,  66},
    {4168,  65}, {4163,  64}, {4157,  63}, {4152,  62}, {4146,  61},
    {4141,  60}, {4135,  59}, {4130,  58}, {4124,  57}, {4119,  56},
    {4113,  55}, {4108,  54}, {4102,  53}, {4097,  52}, {4091,  51},
    {4086,  50}, {4080,  49}, {4075,  48}, {4069,  47}, {4064,  46},
    {4058,  45}, {4053,  44}, {4047,  43}, {4042,  42}, {4036,  41},
    {4031,  40}, {4024,  39}, {4017,  38}, {4009,  37}, {4002,  36},
    {3995,  35}, {3987,  34}, {3980,  33}, {3973,  32}, {3965,  31},
    {3958,  30}, {3951,  29}, {3943,  28}, {3936,  27}, {3929,  26},
    {3922,  25}, {3914,  24}, {3906,  23}, {3897,  22}, {3888,  21},
    {3879,  20}, {3870,  19}, {3860,  18}, {3853,  17}, {3846,  16},
    {3838,  15}, {3831,  14}, {3824,  13}, {3816,  12}, {3809,  11},
    {3802,  10}, {3795,   9}, {3787,   8}, {3780,   7}, {3768,   6},
    {3755,   5}, {3743,   4}, {3730,   3}, {3716,   2}, {3700,   1},
};
